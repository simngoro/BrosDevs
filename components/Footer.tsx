      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">BrosDevs</h3>
            <p className="text-gray-400 mb-4 sm:mb-6 text-sm sm:text-base">
              Dos hermanos escribiendo código que funciona. 
        ...
        <div className="border-t border-gray-800 pt-6 sm:pt-8 text-center">
          <p className="text-gray-500 text-xs sm:text-sm">
            © 2024 BrosDevs. Hecho con ❤️ por hermanos developers.
          </p>
        </div>
      </div>
    </footer>
